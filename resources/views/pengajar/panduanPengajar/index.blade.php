...
<div class="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
    <h1 class="text-2xl sm:text-3xl font-bold mb-6 text-emerald-700 text-center">Panduan & SOP Pengajar</h1>

    <div class="space-y-6">

        <div x-data="{ open: false }" class="bg-white border border-emerald-300 rounded-xl shadow-md overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg">
            <button @click="open = !open" class="w-full text-left px-4 py-3 sm:px-6 sm:py-4 font-semibold text-emerald-800 bg-emerald-100 hover:bg-emerald-200 flex justify-between items-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-75">
                ...
                <svg :class="{'rotate-180': open}" class="w-6 h-6 text-emerald-600 transition-transform duration-300 ease-in-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="open" 
                 ...
                 class="px-4 py-3 sm:px-6 sm:py-4 text-gray-700 text-sm sm:text-base border-t border-emerald-200 overflow-hidden">
                ...
                <ol class="list-decimal list-inside space-y-2">
                    ...
                    <li>Klik tombol <span class="inline-block bg-blue-600 text-white px-2 py-1 rounded text-xs font-semibold whitespace-nowrap"> + Absen Murid</span>.</li>
        ...
        <hr class="border-emerald-300 my-8">

        <div class="pt-4">
            <h2 class="text-2xl sm:text-3xl font-bold mb-6 text-emerald-700 text-center">SOP Pengajar</h2>
            <div x-data="{ open: false }" class="bg-white border border-emerald-300 rounded-xl shadow-md overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg">
                <button @click="open = !open" class="w-full text-left px-4 py-3 sm:px-6 sm:py-4 font-semibold text-emerald-800 bg-emerald-100 hover:bg-emerald-200 flex justify-between items-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-75">
                    <span class="flex items-center text-lg sm:text-xl">
        ...
        <div class="pt-4">
            <h2 class="text-2xl sm:text-3xl font-bold mb-6 text-emerald-700 text-center">Fitur Website Absensi</h2>
            <div x-data="{ open: false }" class="bg-white border border-emerald-300 rounded-xl shadow-md overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg">
                <button @click="open = !open" class="w-full text-left px-4 py-3 sm:px-6 sm:py-4 font-semibold text-emerald-800 bg-emerald-100 hover:bg-emerald-200 flex justify-between items-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-75">
                    <span class="flex items-center text-lg sm:text-xl">
                ...
                <div x-show="open" 
                    ...
                    <ol class="list-decimal list-inside space-y-2">
                        <li><strong>Dashboard</strong>: Tampilan utama setelah login, menampilkan absen murid, info murid, nama pengajar, dan jadwal.</li>
                        <li><strong>Absen Murid</strong>: Melakukan absensi murid TPA.</li>
                        <li><strong>Riwayat Absensi</strong>: Melihat hasil riwayat absensi yang telah dicatat.</li>
                        <li><strong>Info Data Murid</strong>: Melihat semua data murid TPA yang telah terdaftar.</li>
                        <li><strong>Info Data Pengajar</strong>: Melihat semua data pengajar TPA yang telah terdaftar.</li>
                        <li><strong>Panduan Pengajar</strong>: Halaman yang sedang Anda lihat ini, berisi panduan penggunaan sistem.</li>
                        <li><strong>Logout</strong>: Keluar dari halaman dashboard dan kembali ke halaman login.</li>
