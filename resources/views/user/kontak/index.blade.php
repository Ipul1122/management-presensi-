...
@section('navbar-user')
    ...
    <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-1/2">
            <h2 class="text-2xl font-bold mb-4 text-green-700">Alamat TPA Nurul Haq</h2>
        ...
        <div class="w-full md:w-1/2">
            ...
            <form id="kontakForm" class="bg-white p-6 rounded-lg shadow space-y-4">
                ...
                <button type="submit" class="bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 transition-all duration-200">
