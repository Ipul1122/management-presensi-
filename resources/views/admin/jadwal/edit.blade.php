        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin.jadwal.update', $jadwal->id) }}" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Nama Jadwal -->
                    <div class="space-y-2">
                        <label for="nama_jadwal" class=" text-sm font-semibold text-gray-700 flex items-center">
                    ...
                    <!-- Tanggal Jadwal -->
                    <div class="space-y-2">
                        <label for="tanggal_jadwal" class=" text-sm font-semibold text-gray-700 flex items-center">
                    ...
                    <!-- Pukul Jadwal -->
                    <div class="space-y-2">
                        <label for="pukul_jadwal" class=" text-sm font-semibold text-gray-700 flex items-center">
                    ...
                    <!-- Nama Pengajar -->
                    <div class="space-y-2">
                        <label for="nama_pengajar_jadwal" class="text-sm font-semibold text-gray-700 flex items-center" id="label-nama-pengajar">
                        ...
                        <input 
                            ...
                            required
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 text-gray-700 placeholder-gray-400 bg-white/50"
                            placeholder="Masukkan nama pengajar, pisahkan dengan koma jika lebih dari satu"
                        >
                        <p class="text-xs text-gray-500">Jika lebih dari satu pengajar, pisahkan dengan koma. Contoh: Budi, Siti, Andi</p>
                    </div>
                </div>

                <!-- Kegiatan Jadwal - Full Width -->
                <div class="space-y-2">
                    <label for="kegiatan_jadwal" class="text-sm font-semibold text-gray-700 flex items-center" id="label-kegiatan-jadwal">
...
<!-- Tambahkan script untuk menambahkan class flex jika ingin tetap pakai block di HTML -->
<script>
    // Jika ingin tetap pakai 'block' di HTML, gunakan script ini:
    // document.querySelectorAll('label[id^="label-"]').forEach(function(label) {
    //     label.classList.add('flex', 'items-center');
    // });

    // Namun pada contoh di atas, class sudah diganti ke 'flex' langsung di HTML.
</script>
@endsection