    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                const allChecked = document.querySelectorAll('.murid-checkbox:not(:checked)').length === 0;
        ...
        function filterRows() {
            ...
            rows.forEach(row => {
                ...
                console.log('Filtering Row:', {
                    ...
                    selectedClass,
                    matchesClass,
                    elementHTML: kelasElement ? kelasElement.outerHTML : 'No element found'
                });
        ...
        const deleteSingleItemForm = document.getElementById('deleteSingleItemForm');
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                deleteSingleItemForm.action = `{{ url('admin/murid') }}/${id}`;
        ...
        viewButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                setTimeout(() => {
                    ...
                    const dummyData = {
                        nama_anak: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(4) div').textContent,
                        foto: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(3) img')?.src || null,
                        jenis_kelamin: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(5) span').textContent.trim(),
                        kelas: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(7) span').textContent.trim(),
                        alamat: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(6) div').textContent,
                        tanggal_daftar: document.querySelector(`[data-id="${id}"]`).closest('tr').querySelector('td:nth-child(8)').textContent.trim()
                    };
                    ...
                    viewModalContent.innerHTML = `
                        <div class="flex flex-col items-center mb-6">
                            ...
                            <div class="flex space-x-2 mt-2">
                                <span class="px-3 py-1 text-sm font-medium rounded-full ${dummyData.jenis_kelamin.includes('Laki') ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800'}">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900">${dummyData.tanggal_daftar}</p>
                                </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ url('admin/murid') }}/${id}/edit" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200">
