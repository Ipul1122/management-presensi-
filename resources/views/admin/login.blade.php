                        ...
                        <form action="{{ route('admin.login') }}" method="POST" class="space-y-6">
                            ...
                            <div class="relative">
                                <input type="password" 
                                    ...
                                    class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition duration-200 text-gray-700 placeholder-gray-400">
