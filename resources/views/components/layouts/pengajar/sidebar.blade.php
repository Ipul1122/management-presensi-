...
<head>
    ...
    {{-- Tom Select & Alpine JS (Dipertahankan dari file asli Pengajar) --}}
    ...
    {{-- Responsive Styles (Diambil dari Layout Admin) --}}
    <style>
        ...
        * { font-family: 'Inter', sans-serif; }
        ...
        .dropdown-menu.active {
            max-height: 500px; /* Increased height for longer menus */
            opacity: 1;
        }
    ...
    <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
        ...
        <div class="flex flex-1">
            <aside class="sidebar w-72 bg-white/90 backdrop-blur-md shadow-2xl border-r border-white/20 custom-scrollbar overflow-y-auto">
                <div class="p-6 space-y-2">
                    <div class="flex justify-between items-center mb-6">
                        <span class="font-bold text-gray-800 ml-4">Menu Pengajar</span>
                    ...
                    <div class="mb-6">
                        <a href="{{ route('pengajar.dashboard') }}" class="flex items-center space-x-3 p-4 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-xl transition-all duration-300 group">
                    ...
                    <div class="mb-6">
                        <button class="dropdown-toggle w-full flex items-center justify-between p-4 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-xl transition-all duration-300 group" data-dropdown="murid">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="font-medium text-gray-700 group-hover:text-indigo-700">Menu Murid</span>
                            </div>
                        ...
                        <div class="dropdown-menu pl-4 mt-2 space-y-1" id="dropdown-murid">
                            <a href="{{ route('pengajar.muridAbsensi.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                            ...
                            <a href="{{ route('pengajar.muridAbsensi.create') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md flex items-center justify-center">
                                    <i class="fas fa-clipboard-check text-white text-sm"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-600 group-hover:text-indigo-700">Absen Murid</span>
                            </a>
                            
                            <a href="{{ route('pengajar.riwayatMuridAbsensi.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md flex items-center justify-center">
                                    <i class="fas fa-history text-white text-sm"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-600 group-hover:text-indigo-700">Riwayat Absensi</span>
                            </a>

                            <a href="{{ route('pengajar.infoDataMurid.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md flex items-center justify-center">
                                    <i class="fas fa-info-circle text-white text-sm"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-600 group-hover:text-indigo-700">Info Data Murid</span>
                            </a>

                            <a href="{{ route('pengajar.sikapMurid.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md flex items-center justify-center">
                                    <i class="fas fa-medal text-white text-sm"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-600 group-hover:text-indigo-700">Nilai Sikap</span>
                            </a>

                            <a href="{{ route('pengajar.mataPelajaran.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md flex items-center justify-center">
                    ...
                    <div class="mb-6">
                        <a href="{{ route('pengajar.infoDataPengajar.index') }}" class="flex items-center space-x-3 p-4 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 rounded-xl transition-all duration-300 group">
                            <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-chalkboard-teacher text-white"></i>
                            </div>
                            <span class="font-medium text-gray-700 group-hover:text-blue-700">Info Data Pengajar</span>
                        </a>
                    </div>
                    ...
                    <div class="mb-6">
                        <button class="dropdown-toggle w-full flex items-center justify-between p-4 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50 rounded-xl transition-all duration-300 group" data-dropdown="jadwal">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="font-medium text-gray-700 group-hover:text-blue-700">Menu Jadwal</span>
                            </div>
                        ...
                        <div class="dropdown-menu pl-4 mt-2 space-y-1" id="dropdown-jadwal">
                            <a href="{{ route('pengajar.jadwal.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50 rounded-lg transition-all duration-300 group">
                                ...
                                <span class="text-sm font-medium text-gray-600 group-hover:text-blue-700">Lihat Jadwal</span>
                            </a>
                            
                            <a href="{{ route('pengajar.riwayatJadwal.index') }}" class="flex items-center space-x-3 p-3 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50 rounded-lg transition-all duration-300 group">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-md flex items-center justify-center">
                                    <i class="fas fa-calendar-check text-white text-sm"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-600 group-hover:text-blue-700">Riwayat Jadwal</span>
                            </a>
                        </div>
                    </div>
                    
                    <div class="mb-6">
                        <a href="{{ route('pengajar.panduanPengajar.index') }}" class="flex items-center space-x-3 p-4 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-xl transition-all duration-300 group">
                            <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                <i class="fa-solid fa-book text-white"></i>
                            </div>
                            <span class="font-medium text-gray-700 group-hover:text-indigo-700">Panduan Pengajar</span>
                        </a>
                    </div>
            ...
            <main class="main-content flex-1">
                <div class="">
                    {{-- Menggunakan nama yield yang sama dengan file lama agar konten tidak hilang --}}
